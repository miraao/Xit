...
class CommandChecker
{
    static final class COMMAND extends Enum
    {
        ...
        {
            return (COMMAND)Enum.valueOf(jp/pixela/atv_app/CommandChecker$COMMAND, s);
        }
...
_L6:
    ...
    void addRunnable(COMMAND command, Runnable runnable)
    {
        runnable = TAG;
        StringBuilder stringbuilder = new StringBuilder();
        stringbuilder.append("addRunnable command=");
        stringbuilder.append(command);
        PxLog.v(runnable, stringbuilder.toString());
    }
    ...
    static 
    {
        ...
        sFinishCommandKeyCodeArrays = (new Integer[][] {
            new Integer[] {
