...
class ContinuousKeyEventManager
{
    private static final class KeyControlState extends Enum
    {
        ...
        {
            return (KeyControlState)Enum.valueOf(jp/pixela/view/ContinuousKeyEventManager$KeyControlState, s);
        }
...
label0:
        {
            ...
            catch(FileNotFoundException filenotfoundexception)
            {
                ...
                activity.append("e=");
                activity.append(filenotfoundexception);
                PxLog.e(((String) (obj2)), activity.toString());
            }
            obj2 = null;
        }
        activity = obj;
    ...
    // Unreferenced inner class jp/pixela/view/ContinuousKeyEventManager$1

/* anonymous class */
    static class _cls1
    {

        static final int $SwitchMap$jp$pixela$view$ContinuousKeyEventManager$KeyControlState[];

        static 
        {
            $SwitchMap$jp$pixela$view$ContinuousKeyEventManager$KeyControlState = new int[KeyControlState.values().length];
            try
            {
